...
(async () => {
    ...
    const client = pgConnector(dbConfig)
    ...
    await client.connect(async (connection) => {
      ...
      ('HIIT Workout', 'High-Intensity Interval Training workout to boost your heart rate and improve cardiovascular health.', 'Physical Health', 900, 'ADVANCED', 'Perform high-intensity exercises like jumping jacks, burpees, and sprints with short rest intervals.'),
      ('Meditation and Visualization', 'Advanced meditation techniques involving visualization to enhance focus and mental clarity.', 'Relaxation', 1800, 'EXPERT', 'Visualize peaceful scenes or success scenarios, focusing deeply on the details and sensations.'),
